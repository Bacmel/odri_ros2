...
class StretchRobot : public rclcpp::Node
{
  ...
  private:
    ...
    void callbackRobotState(const odri_ros2_msgs::msg::RobotFullState::SharedPtr msg);
  ...
  private:
    ...
    rclcpp::Subscription<odri_ros2_msgs::msg::RobotFullState>::SharedPtr  sub_robot_state_;
