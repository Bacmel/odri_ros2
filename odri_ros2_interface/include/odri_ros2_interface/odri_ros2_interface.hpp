...
class OdriRos2Interface : public rclcpp::Node
{
  public:
    explicit OdriRos2Interface(const std::string &node_name);
    virtual ~OdriRos2Interface();

  private:
    void declareParameters();
    void createOdriRobot(const std::string &robot_yaml_path);

    void callbackTimerExchange();
    void callbackRobotCommand(const odri_ros2_msgs::msg::RobotCommand::SharedPtr msg);
    void callbackTransitionCommand(const std::shared_ptr<odri_ros2_msgs::srv::TransitionCommand::Request>  request,
  ...
  private:
    rclcpp::TimerBase::SharedPtr timer_exchange_;

    rclcpp::Publisher<odri_ros2_msgs::msg::RobotState>::SharedPtr  pub_robot_state_;
    rclcpp::Subscription<odri_ros2_msgs::msg::RobotCommand>::SharedPtr sub_robot_command_;
    rclcpp::Service<odri_ros2_msgs::srv::TransitionCommand>::SharedPtr srv_transition_command_;

    std::shared_ptr<odri_control_interface::Robot> odri_robot_;

    odri_ros2_msgs::msg::RobotState robot_state_msg_;

    Eigen::VectorXd vec_zero_;
    ...
    struct Params
    {
        ...
        Eigen::VectorXd parking_position;
    } params_;
